...
urlpatterns = [
    ...
    path('practices/<int:pk>/delete', views.practice_finish, name='practice-finish'),
    ...
    path('poles/<int:pk>/delete', views.pole_destroy, name='pole-destroy'),
    ...
    path('practices/<int:pk>/export', views.export_practice, name='practice-export'),
